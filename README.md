...
- **開発ツール群（アセンブラ・リンカ・デバッガなど）**：
  - Digital Research Inc.（ASM, MAC, RMAC, LINK, LOAD, DDT, SID, ZSID など）
  - Microsoft（M80, L80, LIB80 など）
  - SLR Systems（Z80ASM, SLRINK など）
- **Microsoft MBASIC** — Microsoft Corporation（1977年・1985-1986年）
...
| MAC, RMAC, SID, ZSIDなど | Digital Research Inc. |  |
| M80, L80, LIB80など | Microsoft Corporation (1981年頃)  | 歴史的保存および教育目的でのみ同梱。 |
| Z80ASM, SLRINK など | SLR Systems (1983-1986年頃)  |  歴史的保存および教育目的でのみ同梱。 | 
| MS-BASIC等 (`cpm22_disk1.*`) | (C) Microsoft Corporation (1977,1985-1986) / Z80-MBC2同梱 | 非公式アーカイブ。歴史的保存および教育目的でのみ同梱。 |
| XLISP 1.1 | David Michael Betz (1984-1988) | パブリックドメイン |  
...
> [!IMPORTANT]  
> **CP/M 2.2, MAC, RMAC, SID, ZSIDなど** バイナリは 2022年の DRDOS, Inc. / Bryan Sparks の許可に基づき再配布されています(詳細：http://www.cpm.z80.de/license.html)。  
> **Z80ASM, SLRINKなど** 著作権は SLR Systemsに帰属します。歴史的保存および教育目的でのみ利用。  
> **MS-BASIC, M80, L80, LIB80など** レトロコンピューティングコミュニティにおいて歴史的・教育的資料として広く共有されているものです。著作権は Microsoft Corporation に帰属します。商用利用を避け、個人の学習・研究目的でのみ利用してください。
