 ...
 */
/* 
 Modified 2026 @DragonBallEZ(kyo-ta04). SPDX-License-Identifier: BSD-3-Clause
*/
...
int getnum(char *cp);  /* static int getnum(char *cp); */
void copyout(int cnt); /* static void copyout(int cnt); */
