/*
 * Derived from Version 7 Unix cmp.c
 * Source: https://github.com/v7unix/v7unix/blob/master/v7/usr/src/cmd/cmp.c
 *
...
char **argv;
{
	...
	if( arg[0]=='-' && arg[1]==0 )
		file1 = stdin;
	else if((file1 = fopen(arg, "rb")) == NULL)
		goto barg;
	arg = argv[2];
	if((file2 = fopen(arg, "rb")) == NULL)
		goto barg;
	if (argc>3)
		skip1 = otoi(argv[3]);
	if (argc>4)
